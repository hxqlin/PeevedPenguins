...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        // asldkjasdj
        /* Set reference to buttonRestart */
        ...
        let catapultPinJoint = SKPhysicsJointPin.joint(withBodyA: catapult.physicsBody!, bodyB: catapultArm.physicsBody!, anchor: CGPoint(x:-72 ,y:-60))
    ...
    func dieSeal(_ node: SKNode) {
        ...
        /* Play SFX */
        let sealSFX = SKAction.playSoundFileNamed("sfx_punch", waitForCompletion: false)
        self.run(sealSFX)
